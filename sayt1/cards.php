        ...
        <div class="card card_border mb-5">
          ...
          <div class="card-body">
            <div class="card-columns">
              <div class="card">
                <img src="assets2/images/cart.jpg" class="card-img-top" alt="...">
                <div class="card-body">
              ...
              <div class="card">
                <img src="assets2/images/template2.jpg" class="card-img-top" alt="...">
                <div class="card-body">
              ...
              <div class="card">
                <img src="assets2/images/dashboard.jpg" class="card-img-top" alt="...">
              </div>
        ...
        <div class="card card_border mb-5">
          ...
          <div class="card-body">
            <div class="row row-cols-1 row-cols-md-2">
              ...
              <div class="col mb-4">
                <div class="card">
                  <img src="assets2/images/desk.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                      additional
