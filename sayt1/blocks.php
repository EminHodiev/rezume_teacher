...
<section>
  ...
  <!-- if logo is image enable this -->
    ...
    <div class="logo-icon text-center">
      <a href="index.html" title="logo"><img src="assets2/images/logo.png" alt="logo-icon"> </a>
    </div>
    <!-- //logo end -->
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="assets2/images/avatar1.jpg" alt=""></div>
                  ...
                  <li class="odd"><a href="#" class="grid">
                      <div class="user_img"><img src="assets2/images/avatar2.jpg" alt=""></div>
                      <div class="notification_desc">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="assets2/images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
              ...
              <li class="dropdown profile_details_drop">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                  ...
                  <div class="profile_img">
                    <img src="assets2/images/profileimg.jpg" class="rounded-circle" alt="" />
      ...
      <div class="card-body py-3 p-0">
        <div class="row">
          ...
          <div class="col-lg-6 pl-lg-4 mt-lg-0 mt-4">
            <img src="assets2/images/template2.jpg" alt="" class="img-fluid rounded" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body py-3 p-0">
        <div class="row">
          <div class="col-lg-6 pr-lg-4">
            <img src="assets2/images/template1.jpg" alt="" class="img-fluid rounded" />
          </div>
    ...
    <div class="card card_border p-lg-5 p-3 mb-4">
      <div class="card-body py-3 p-0">
        <div class="row">
          ...
          <div class="col-lg-6 pl-lg-4 mt-lg-0 mt-4">
            <img src="assets2/images/dashboard.jpg" alt="" class="img-fluid rounded" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body py-3 p-0">
        ...
        <div class="row">
          <div class="col-md-4 column mt-md-3 mt-3">
            <a href="#img1"><img class="img-fluid rounded" src="assets2/images/template2.jpg" alt=""></a>
            <a href="#para1">
          ...
          <div class="col-md-4 column mt-md-3 mt-5">
            <a href="#img1"><img class="img-fluid rounded" src="assets2/images/cart.jpg" alt=""></a>
            <a href="#para2">
              <p class="grid-para">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
            </a>
            <a href="#caption2">
          ...
          <div class="col-md-4 column mt-md-3 mt-5">
            <a href="#img1"><img class="img-fluid rounded" src="assets2/images/dashboard.jpg" alt=""></a>
            <a href="#para3">
              <p class="grid-para">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
            </a>
            <a href="#caption3">
      ...
      <div class="card-body py-3 p-0">
        ...
        <div class="row cwp23-content align-items-lg-center">
          <div class="cwp23-img col-md-6 pt-md-4 mt-md-0 mt-3">
            <img src="assets2/images/content.jpg" class="img-fluid rounded" alt="">
          </div>
      ...
      <div class="card-body py-3 p-0">
        ...
        <div class="row cwp23-content">
          ...
          <div class="col-md-6 mt-md-0 mt-5 cwp23-img">
            <img src="assets2/images/template2.jpg" class="img-fluid rounded" alt="">
          </div>
        </div>
      </div>
    </div>
